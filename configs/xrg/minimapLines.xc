 ...
 */
{
  "lines": {
       ...
       "vehicle": [
         { "enabled": false, "from": 1200,  "to": 0, "inmeters": false, "thickness": 0.5, "alpha": 60, "color": "0xA8FF00"}
       ],
       // Camera direction.
       ...
       "traverseAngle": [
         { "enabled": true, "from": 0,  "to": 300, "inmeters": false, "thickness": 0.4, "alpha": 60, "color": "0xFFFFFF"}
       ]
    }
}