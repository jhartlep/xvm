 ...
 */
{
  "labels": {
      ...
      "vehicleclassmacro": {
        ...
        // http://goo.gl/d2KIj
        "light": "<font face='XVM'>L</font>" ,
        "medium": "<font face='XVM'>M</font>",
        "heavy": "<font face='XVM'>H</font>",
        "td": "<font face='XVM'>T</font>",
        "spg": "<font face='XVM'>S</font>",
        "superh": "<font face='XVM'>H</font>"
      },
      ...
      "units": {
        ...
        "format": {
          ...
          "lostsquad":      "<textformat leading='-4'><span class='mm_dot'>{{vehicle-class}}</span><span class='mm_ls'>{{short-nick}}\n   {{vehicle}}</span><textformat>",
          // Мертвый союзник.
          ...
          // Мертвый взводный.
          "deadsquad":      "<span class='mm_dot'>{{vehicle-class}}</span><span class='mm_ds'>{{short-nick}}</span>"
        },
        ...
        "css": {
          ...
          "lostally":       ".mm_la{font-family:$FieldFont; font-size:6px; color:#C8FFA6;} .mm_dot{font-family:$FieldFont; font-size:11px; color:#B4E595;}",
          "lostteamkiller": ".mm_lt{font-family:$FieldFont; font-size:6px; color:#A6F8FF;} .mm_dot{font-family:$FieldFont; font-size:11px; color:#00D2E5;}",
          "lost":            ".mm_l{font-family:$FieldFont; font-size:6px; color:#FCA9A4;} .mm_dot{font-family:$FieldFont; font-size:11px; color:#E59995;}",
          "lostsquad":      ".mm_ls{font-family:$FieldFont; font-size:6px; color:#FFD099;} .mm_dot{font-family:$FieldFont; font-size:11px; color:#E5BB8A;}",
          "deadally":       ".mm_da{font-family:$FieldFont; font-size:6px; color:#6E8C5B;} .mm_dot{font-family:$FieldFont; font-size:11px; color:#004D00;}",
          "deadteamkiller": ".mm_dt{font-family:$FieldFont; font-size:6px; color:#5B898C;} .mm_dot{font-family:$FieldFont; font-size:11px; color:#043A40;}",
          "deadenemy":      ".mm_de{font-family:$FieldFont; font-size:6px; color:#996763;} .mm_dot{font-family:$FieldFont; font-size:11px; color:#4D0300;}",
          "deadsquad":      ".mm_ds{font-family:$FieldFont; font-size:6px; color:#997C5C;} .mm_dot{font-family:$FieldFont; font-size:11px; color:#663800;}"
        },
        // Fields shadow.
        // Тени полей.
        ...
        "offset": {
          ...
          "oneself":        {"x": 0, "y": 0},
          "lostally":       {"x": -7, "y": -7},
          "lostteamkiller": {"x": -7, "y": -7},
          "lost":           {"x": -7, "y": -7},
          "lostsquad":      {"x": -7, "y": -7},
          "deadally":       {"x": -7, "y": -7},
          "deadteamkiller": {"x": -7, "y": -7},
          "deadenemy":      {"x": -7, "y": -7},
          "deadsquad":      {"x": -7, "y": -7}
        },
